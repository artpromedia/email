  ...
  const rotateDKIM = async () => {
    ...
    try {
      ...
      setDnsRecords(prev => prev.map(record => 
        record.type === 'DKIM' 
          ? { ...record, name: `${newSelector}._domainkey.${selectedDomain}`, status: 'pending' as const }
          : record
      ))
      
      // Log the action (in real implementation, send to audit log)
      console.log(`DKIM rotated for domain ${selectedDomain}, new selector: ${newSelector}`)
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600">Monitor DNS configuration and email reputation</p>
        </div>
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics.tlsReportCount.toLocaleString()}</div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-medium mb-2">Add these DNS records to your domain:</h4>
