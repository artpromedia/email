...
export interface paths {
    ...
    "/mail/compose/from-message": {
        ...
        get?: never;
        put?: never;
        /** Compose reply, reply-all, or forward from existing message */
        post: operations["composeFromMessage"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ComposeFromMessageRequest: {
            /**
             * Format: uuid
             * @description ID of the original message to reply to or forward
             */
            messageId: string;
            /**
             * @description Type of composition action
             * @enum {string}
             */
            action: "reply" | "replyAll" | "forward";
            /**
             * @description Whether to include attachments (forward only)
             * @default true
             */
            includeAttachments: boolean;
            /**
             * @description How to handle inline CID references (forward only)
             * @default preserve
             * @enum {string}
             */
            inlineCidStrategy: "preserve" | "flatten";
            /** @description Optional selected text to quote instead of full message */
            selectedTextHtml?: string;
        };
        ComposeFromMessageResponse: {
            /**
             * Format: uuid
             * @description ID of the created draft
             */
            draftId: string;
            /** @description Pre-filled recipient addresses */
            to: string[];
            /** @description Pre-filled CC addresses */
            cc: string[];
            /** @description Pre-filled BCC addresses */
            bcc: string[];
            /** @description Pre-filled subject line */
            subject: string;
            /** @description Email headers for threading */
            headers: {
                /** @description Message-ID of the original message */
                "In-Reply-To"?: string;
                /** @description Message threading references */
                References?: string[];
            };
            /** @description Pre-filled HTML body with quoted content */
            bodyHtml: string;
            /** @description True if attachments were excluded due to size limits */
...
export interface operations {
    ...
    composeFromMessage: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ComposeFromMessageRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ComposeFromMessageResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            404: components["responses"]["NotFound"];
