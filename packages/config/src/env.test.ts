...
describe('Environment Validation', () => {
  ...
  describe('validateEnv', () => {
    ...
    it('should throw when PRIMARY_DOMAIN not in ALLOWED_DOMAINS', () => {
      ...
      expect(() => validateEnv(invalidEnv)).toThrow('PRIMARY_DOMAIN must be included in ALLOWED_DOMAINS');
    });
    ...
    it('should throw when DEFAULT_DOMAIN not in ALLOWED_DOMAINS', () => {
      ...
      expect(() => validateEnv(invalidEnv)).toThrow('DEFAULT_DOMAIN must be included in ALLOWED_DOMAINS');
    });
    ...
    it('should throw when DATABASE_POOL_MAX < DATABASE_POOL_MIN', () => {
      ...
      expect(() => validateEnv(invalidEnv)).toThrow('DATABASE_POOL_MAX must be >= DATABASE_POOL_MIN');
    });
  ...
  describe('Enum Validation', () => {
    ...
    it('should reject invalid NODE_ENV', () => {
      expect(() =>
        validateEnv({ ...baseValidEnv, NODE_ENV: 'invalid' })
      ).toThrow();
    });
